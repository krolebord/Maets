...
fse.emptyDirSync(path.join(publicDir, 'sql-highlight'));
...
fse.copySync(path.join(nodeModulesDir, 'sql-highlight', 'lib'), path.join(publicDir, 'sql-highlight'), { overwrite: true });
